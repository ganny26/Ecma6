...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__HistoryUtils__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__HistoryUtils___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__HistoryUtils__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__LoggingUtils__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__StringifyUtils__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__StringifyUtils___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__StringifyUtils__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__TabKeyPress__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__TabKeyPress___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__TabKeyPress__);
...
((window) => {
    ...
    window.info = function (cmd) {
        ...
        li.className = 'info';
        li.innerHTML = '<span class="gutter"></span><div>' + __WEBPACK_IMPORTED_MODULE_0__Utils___default.a.clearConsole(cmd) + '</div>';
        __WEBPACK_IMPORTED_MODULE_0__Utils___default.a.appendLog(li);
    }
    ...
    let executeCommand = (cmd) => {
        ...
        var rawoutput = null,
            className = 'response',
            internalCmd = __WEBPACK_IMPORTED_MODULE_0__Utils___default.a.internalCommand(cmd);
        ...
        if (internalCmd) {
            ...
            return [className, __WEBPACK_IMPORTED_MODULE_0__Utils___default.a.clearConsole(__WEBPACK_IMPORTED_MODULE_3__StringifyUtils___default.a.stringifyContent(rawoutput))];
        }
    }
  ...
  */
    let post = (cmd, blind, response) => {
        cmd = __WEBPACK_IMPORTED_MODULE_0__Utils___default.a.trim(cmd);
        ...
        if (blind === undefined) {
            history.push(cmd);
            __WEBPACK_IMPORTED_MODULE_1__HistoryUtils___default.a.setHistory(history);
            if (historySupported) {
  ...
  */
    var exec = document.getElementById('exec'),
        ...
        history = __WEBPACK_IMPORTED_MODULE_1__HistoryUtils___default.a.getHistory(),
...
*/
   ...
   */
    exec.onkeydown = function (event) {
        ...
        if (keys[which]) {
            if (event.shiftKey) {
                __WEBPACK_IMPORTED_MODULE_4__TabKeyPress___default.a.changeView(event);
            } else if (!wide) { // history cycle
                if (enableCC && window.getSelection) {
                    window.selObj = window.getSelection();
                    var selRange = selObj.getRangeAt(0);

                    cursorPos = __WEBPACK_IMPORTED_MODULE_0__Utils___default.a.findNode(selObj.anchorNode.parentNode.childNodes, selObj.anchorNode) + selObj.anchorOffset;
                ...
                if (history[pos] != undefined && history[pos] !== '') {
                    removeSuggestion();
                    __WEBPACK_IMPORTED_MODULE_0__Utils___default.a.setCursorTo(history[pos])
                    return false;
                } else if (pos == history.length) {
                    removeSuggestion();
                    __WEBPACK_IMPORTED_MODULE_0__Utils___default.a.setCursorTo('');
                    return false;
                }
            }
            ...
            __WEBPACK_IMPORTED_MODULE_4__TabKeyPress___default.a.checkTab(event);
   ...
   */
    if (enableCC && iOSMobile) {
        ...
        fakeInput.onkeyup = function (event) {
            cursor.innerHTML = __WEBPACK_IMPORTED_MODULE_0__Utils___default.a.clearConsole(this.value);
            var which = LoggingUtils.whichKey(event);
            if (enableCC && which != 9 && which != 16) {
                clearTimeout(codeCompleteTimer);
                codeCompleteTimer = setTimeout(function () {
   ...
   */
    document.onkeydown = (event) => {
        ...
        return __WEBPACK_IMPORTED_MODULE_4__TabKeyPress___default.a.changeView(event);
    };
...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Utils__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Utils___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__Utils__);
 ...
 /**
    ...
    let log = (msg, className) => {
        ...
        div.innerHTML = typeof msg === 'string' ? __WEBPACK_IMPORTED_MODULE_0__Utils___default.a.clearConsole(msg) : msg;
        prettyPrint([div]);
    ...
    let echo = (cmd) => {
        var li = document.createElement('li');
        li.className = 'echo';
        li.innerHTML = __WEBPACK_IMPORTED_MODULE_0__Utils___default.a.clearConsole(cmd) + '<a href="/?' + encodeURIComponent(cmd) + '" class="permalink" title="permalink">link</a></div>';
        logAfter = null;
        ...
        __WEBPACK_IMPORTED_MODULE_0__Utils___default.a.appendLog(li, true);
    }
